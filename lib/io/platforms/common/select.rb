...
class IO
  module Platforms
    # nodoc
    # The reason that we combine Constants, Functions, and Structs all in
    # one file instead of splitting them out is because this is the fallback
    # Poller if a platform-specific one can't be found. We do NOT want to load
    # this in the general case and pollute the namespace.
    module Constants
      FDSET_SIZE      = 1024
      FD_BIT0         = 0x1
      FD_BIT1         = 1 << 1
